...
namespace delivery_manager {
    ...
    public partial class deliveryDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientsDataTable : global::System.Data.TypedTableBase<ClientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientsRow AddClientsRow(string FIO, string Address) {
...
namespace delivery_manager.deliveryDataSetTableAdapters {
    ...
    public partial class ClientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Clients] WHERE (([ID_Client] = @Original_ID_Client) AND ([FIO]" +
                " = @Original_FIO) AND ([Address] = @Original_Address))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clients] ([FIO], [Address]) VALUES (@FIO, @Address);\r\nSELECT I" +
                "D_Client, FIO, Address FROM Clients WHERE (ID_Client = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Clients] SET [FIO] = @FIO, [Address] = @Address WHERE (([ID_Client]" +
                " = @Original_ID_Client) AND ([FIO] = @Original_FIO) AND ([Address] = @Original_A" +
                "ddress));\r\nSELECT ID_Client, FIO, Address FROM Clients WHERE (ID_Client = @ID_Cl" +
                "ient)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::delivery_manager.Properties.Settings.Default.deliveryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_Client, FIO, Address FROM dbo.Clients";
        ...
        public virtual int Fill(deliveryDataSet.ClientsDataTable dataTable) {
        ...
        public virtual deliveryDataSet.ClientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            deliveryDataSet.ClientsDataTable dataTable = new deliveryDataSet.ClientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(deliveryDataSet.ClientsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(deliveryDataSet dataSet) {
        ...
        public virtual int Delete(int Original_ID_Client, string Original_FIO, string Original_Address) {
        ...
        public virtual int Insert(string FIO, string Address) {
            if ((FIO == null)) {
        ...
        public virtual int Update(string FIO, string Address, int Original_ID_Client, string Original_FIO, string Original_Address, int ID_Client) {
            if ((FIO == null)) {
                throw new global::System.ArgumentNullException("FIO");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FIO, string Address, int Original_ID_Client, string Original_FIO, string Original_Address) {
            return this.Update(FIO, Address, Original_ID_Client, Original_FIO, Original_Address, Original_ID_Client);
        }
    }
